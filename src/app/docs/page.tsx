    ...
    <>
      ...
      <div className="layout">
        ...
        <nav className="sidebar" id="sidebar">
          ...
          <div className="nav-group">
            <div className="nav-group-title">Endpoints</div>
            <a href="#extract" className="nav-link"><span className="nav-method method-post">POST</span>/v1/extract</a>
            <a href="#detect" className="nav-link"><span className="nav-method method-post">POST</span>/v1/detect</a>
            <a href="#usage" className="nav-link"><span className="nav-method method-get">GET</span>/v1/usage</a>
            <a href="#health" className="nav-link"><span className="nav-method method-get">GET</span>/v1/health</a>
          </div>
          <div className="nav-group">
            <div className="nav-group-title">Billing</div>
            <a href="#checkout" className="nav-link"><span className="nav-method method-post">POST</span>/v1/billing/checkout</a>
            <a href="#portal" className="nav-link"><span className="nav-method method-post">POST</span>/v1/billing/portal</a>
          </div>
          <div className="nav-group">
