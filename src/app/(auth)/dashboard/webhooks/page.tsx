...
export default function WebhooksPage() {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 max-w-2xl mx-auto text-center">
      ...
      <h2 className="font-headline font-bold text-2xl text-on-surface mb-2">Webhooks</h2>
      ...
      <p className="text-on-surface-variant text-sm leading-relaxed max-w-md mb-8">
        Configure webhook endpoints to receive real-time notifications when extractions complete, fail, or hit confidence thresholds.
      </p>
      <Link
        href="/dashboard"
