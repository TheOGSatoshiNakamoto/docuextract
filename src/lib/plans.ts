...
export const PLANS: Record<Plan, PlanConfig> = {
  free:    { name: 'Free',    price: 0,   extractions: 50,    rateLimit: 5,   sonnetAccess: false, overage: null,  maxKeys: 2 },
  starter: { name: 'Starter', price: 49,  extractions: 1500,  rateLimit: 30,  sonnetAccess: true,  overage: 0.04,  maxKeys: 5 },
  pro:     { name: 'Pro',     price: 99,  extractions: 5000,  rateLimit: 60,  sonnetAccess: true,  overage: 0.025, maxKeys: 10 },
  scale:   { name: 'Scale',   price: 249, extractions: 20000, rateLimit: 120, sonnetAccess: true,  overage: 0.015, maxKeys: 25 },
};
